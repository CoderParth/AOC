...
// snack storage, a giant Rock Paper Scissors tournament
// is already in progress.
//
// Rock Paper Scissors is a game between two players. Each
// game contains many rounds; in each round, the players
// each simultaneously choose one of Rock, Paper, or Scissors
// using a hand shape. Then, a winner for that round is
// selected: Rock defeats Scissors, Scissors defeats Paper,
// and Paper defeats Rock. If both players choose the same
...
// your opponent is going to play: A for Rock, B for Paper,
// and C for Scissors. The second column--" Suddenly, the Elf
